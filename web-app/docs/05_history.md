...
- Renamed all instances of 'Travellounge' (and variants) to 'Royal Travel'/'RoyalTravel' across web-app, admin-app, and mobile-app.
- Generated new premium header and footer logos and deployed them.
- Forced favicon and email templates to use the new branding.
