...
## Global Alignment
The ecosystem unifies three authoritative layers:
1. [Web Application (Guest-Facing)](../web-app/README.md)
2. [Admin Portal (Administrative)](../admin-app/README.md)
3. [Mobile Application (Concierge)](../mobile-app/README.md)
